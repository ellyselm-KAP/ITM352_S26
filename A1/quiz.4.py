...
# Date : Feb. 24, 2026
# Let the user select the correct answer by its label
...
for question, options in QUESTIONS.items():
    ...
    answer_label = int(input("Your choice: "))
    answer = sorted_options[answer_label - 1]  # Get the answer based on the label
